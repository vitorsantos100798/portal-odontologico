...
const Historico = () => {
  ...
  const filteredHistorico = historico.filter(item => {
    ...
    const matchesPeriodo = selectedPeriodo === '' || (() => {
  ...
  const totalGasto = filteredHistorico.reduce((sum, item) => sum + item.valor, 0);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Histórico de Atendimento</h1>
          <p className="text-gray-600">Visualize todos os seus procedimentos realizados</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {historico.length > 0 ? historico[0].procedimento : 'Nenhum atendimento'}
            </p>
          </CardContent>
        </Card>
      </div>
        ...
        <CardContent className="space-y-4">
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1">
              <Label htmlFor="search">Buscar procedimento, dentista ou clínica</Label>
                ...
                <div className="flex-1 space-y-3">
                  <div className="flex items-start justify-between">
                    ...
                    <div className="text-right">
                      <p className="text-lg font-semibold text-[#B7335D]">
